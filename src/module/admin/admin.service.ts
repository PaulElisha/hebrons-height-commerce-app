...
class AdminService {
 getAnalytics = async (): Promise<Result<TAdminAnalytics, AppError>> => {
 ...
 getUser = async (userId: string): Promise<Result<TUserFull, AppError>> => {
 ...
 deleteProduct = async (productId: string): Promise<Result<void, AppError>> => {
 ...
 ): Promise<Result<TSubcategory, AppError>> => {
